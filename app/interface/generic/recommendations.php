...
?>
<title><?= dictionary_getPageTitle(D['title_recommendations']); ?></title>
...
<?
	...
	$template->search_condition = "JOIN links AS l ON l.from_id = o.id AND l.user_id = $user_id AND l.type_id = 6
